---
title: 'Injusticias del día día'
description: 'Crónica de una discriminación en una sucursal bancaria y la falta de accesibilidad y empatía.'
pubDate: 2021-10-21
category: 'Denuncia'
heroImage: '/images/blog/injusto.webp'
---

Había una vez una poderosa entidad pública llamada BBVA. A lo largo del tiempo fueron adquiriendo cada día más y más poder con el dinero de los ciudadanos; sin embargo con ese dinero de los ciudadanos iban menguando cada vez más y más sus derechos cometiendo diversas injusticias.

Aconteció un día cualquiera; que personas con pleno derecho en la sociedad acudieron a una sucursal de esta poderosa entidad para hacer uso de su dinero; pero se les negó el acceso.
...
Pero la persona que está solicitando la entrada a la entidad no está haciendo ninguna foto; por lo que sigue insistiendo en que le permitan el acceso puesto que tiene su dinero en esta entidad y necesita usar el cajero. En ese momento interviene el guardia de seguridad; con total impunidad y prepotencia, denegando injustamente la petición de la persona con diversidad funcional que necesita la rampa para acceder.

<div class="grid grid-cols-1 md:grid-cols-2 gap-8 my-8 items-center">
  <div class="w-full">
    <img src="/images/blog/segurido.jpg" alt="Seguridad impidiendo el paso" class="w-full h-auto rounded-xl shadow-lg object-cover" style="max-height: 300px; width: 100%; object-fit: cover;">
  </div>
  <div class="w-full h-full flex items-center justify-center" style="min-height: 300px;">
    <iframe 
      src="https://www.youtube.com/embed/pdccTpCEEc8" 
      title="Guardián prepotente" 
      frameborder="0" 
...
## El tiempo pasa y la situación de injusticias continúa

El turno de usar el cajero va pasando; y el guardia de seguridad dice a los de detrás que se salten a la persona con diversidad funcional y entren ellos primero. ¿Cómo puede tomarse esa libertad de decidir el turno en el que entran las personas? por las acciones que esta llevando a cabo otra persona ajena.

Creemos que se ha excedido en sus funciones claramente; además con cierta prepotencia, y ha discriminado los derechos de la persona que le pertenecía entrar negándole la rampa de acceso. Lamentable pero cierto.

Llegados a este punto la persona que está haciendo fotos solicita la solidaridad a todas las personas que se hallaban en la cola esperando turno. En ese momento hemos observado con tristeza como se ha perdido la solidaridad en nuestra sociedad; es muy triste desde luego, y así nos va como nos va. Cabría hacer una reflexión bastante importante para darse cuenta de que esta pasando con la humanidad, la solidaridad, la empatía, la igualdad, los derechos… y en que nos estamos convirtiendo; en una sociedad totalmente injusta.

## Desenlace y reflexión de injusticias
...
A qué esperamos tíos, de que vamos… vomitemos todos en la puerta de su local. No permitamos estas injusticias.

### Actualización a 21 de octubre de 2021
